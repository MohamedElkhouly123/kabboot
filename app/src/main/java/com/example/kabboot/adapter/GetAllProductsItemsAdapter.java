...
public class GetAllProductsItemsAdapter extends RecyclerView.Adapter<GetAllProductsItemsAdapter.ViewHolder> {
    ...
    private List<AllProduct> allProducts = new ArrayList<>();
    private NavController navController;
    private static boolean show = false;

    public GetAllProductsItemsAdapter(Context context, Activity activity, String dealOrPromo, String onSoreOrAllProducts, NavController navController, List<AllProduct> allProducts) {
        allProducts.clear();
